...
export const ChartBarDeals = ({ data }) => {
    ...
    return (
        <div className='col-span-2 sm:col-span-4 items-center justify-center h-64 rounded-xl bg-secondary-100'>
            <span className='flex text-white text-sm md:text-base font-semibold text-center justify-center mt-2'>
                Number of deals, weighted and total amount according to the stage before closing
            </span>
